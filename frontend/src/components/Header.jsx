...
const Header = () => {
  return (
    <div className="max-w-7xl mx-auto my-7 relative rounded-xl overflow-hidden shadow-lg">
      <div
        style={{ backgroundImage: `url(${header})` }}
        className="h-[700px] w-full bg-cover bg-center"
      >
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6 bg-opacity-30">
